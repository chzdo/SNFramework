...
class Mailer {
    ...
    async sendMail({ from = this.FROM, subject, html, templateName, tags = {}, to = [], attachments = [], recipientVariable = {}, cc = [] }) {
        let { subject: subjectTemplate, body } = html ? {} : await this.getTemplates(templateName);
